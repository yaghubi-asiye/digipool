...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('')}}/app-assets/css-rtl/pages/error.min.css">
    <!-- END: Page CSS-->
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-8 col-10 p-0">
                        <div class="card-header bg-transparent border-0">
                            <h2 class="error-code text-center mb-2 white">IP Error</h2>
                            <h3 class="text-uppercase text-center white">فقط آی پی های IP ایران اجازه دسترسی دارند.</h3>
                        </div>
                        <div class="card-content">

                            <div class="row py-2 text-center">
                                <div class="col-12">
                                    <a href="{{asset('')}}" class="btn btn-white danger box-shadow-4"><i
                                                class="ft-home"></i> بازگشت به خانه</a>
                                </div>
